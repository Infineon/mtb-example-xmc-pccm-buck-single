# XMC&trade; MCU: PCCM buck converter
...
The following example clones the "[mtb-example-xmc-pccm-buck-single](https://github.com/Infineon/mtb-example-xmc-pccm-buck-single)" application with the desired name "PCCM_buck" configured for the *KIT_XMC42_DPCC_V1* BSP into the specified working directory, *C:/mtb_projects*:
