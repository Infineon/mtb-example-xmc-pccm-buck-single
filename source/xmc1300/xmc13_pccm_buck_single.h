/******************************************************************************
* File Name:   xmc13_pccm_buck_single.h
*
* Description: This file provides functions for initializing the filter
*              structure, and perform the 2 poles 2 zeros filtering to the
...
********************************************************************************
* Summary:
* Function performs the initialization of the peripherals, compensator,
* and interrupt.
*
* Parameters:
*  void
